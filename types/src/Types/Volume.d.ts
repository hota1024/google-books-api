...
export declare type VolumeInfoIndustryIdentifierType = 'ISBN_10' | 'ISBN_13' | 'ISSN' | 'OTHER';
export declare type VolumeInfoIndustryIdentifier = {
    /**
...
export declare type VolumeInfoDimensions = {
    /**
...
export declare type VolumeInfoImageLinks = {
    /**
...
export declare type VolumeInfoPrintType = 'BOOK' | 'MAGAZINE';
...
export declare type SaleInfoListPriceRetailPrice = {
    /**
...
export declare type SaleInfoListPrice = {
    /**
     * Amount in the currency listed below. (In LITE projection.)
     */
    amount: number;
...
export declare type AccessInfoViewability = 'PARTIAL' | 'ALL_PAGES' | 'NO_PAGES' | 'UNKNOWN';
export declare type AccessInfoEpub = {
    /**
...
export declare type AccessInfoPdf = {
    /**
...
export declare type AccessInfoDownloadAccess = {
    /**
     * Resource type.
     */
    kind: string;
...
export declare type AccessInfoAccessViewStatus = 'FULL_PURCHASED' | 'FULL_PUBLIC_DOMAIN' | 'SAMPLE' | 'NONE';
export declare type AccessInfoTextToSpeechPermission = 'ALLOWED' | 'ALLOWED_FOR_ACCESSIBILITY' | 'NOT_ALLOWED';
export declare type AccessInfo = {
    /**
